...
var _user$project$Patient_Main$pairedProviderInfo = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('someone'),
		_1: {ctor: '[]'}
	});
var _user$project$Patient_Main$nextAppointmentInfo = function (time) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Patient_Main$infoRow = function (time) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Patient_Main$nextAppointmentInfo(time),
			_1: {
				ctor: '::',
				_0: _user$project$Patient_Main$pairedProviderInfo,
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Patient_Main$getNextAppointmentTime = A2(
	_elm_lang$http$Http$send,
	_user$project$Patient_Main$GetNextAppointmentTime,
...
var _user$project$Patient_Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Patient_Main$init,
		update: _user$project$Patient_Main$update,
		view: _user$project$Patient_Main$view,
...
var Elm = {};
Elm['Patient'] = Elm['Patient'] || {};
Elm['Patient']['Main'] = Elm['Patient']['Main'] || {};
if (typeof _user$project$Patient_Main$main !== 'undefined') {
    _user$project$Patient_Main$main(Elm['Patient']['Main'], 'Patient.Main', undefined);
}
